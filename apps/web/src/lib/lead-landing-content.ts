...
export const LANDING_CONTENT: Record<Intent, LandingContent> = {
    ...
    steps: [
      {
        ...
        body: "Neighborhoods, budget, must-haves. A minute, tops.",
      },
      {
        n: "02",
        title: "Nilyan curates matches",
        body: "A shortlist that fits, including quiet off-market listings.",
      },
      {
        n: "03",
        title: "Tour, offer, close",
        body: "Local guidance through every showing, offer and signature.",
      },
    ],
    hook: {
    ...
    steps: [
      {
        ...
        body: "The address and a few details about the home.",
      },
      {
        n: "02",
        title: "Get a real valuation",
        body: "A price backed by recent local comparable sales, not a guess.",
      },
      {
        n: "03",
        title: "List and sell",
        body: "Staging, marketing and negotiation handled end to end.",
      },
    ],
    hook: {
  ...
  rent: {
    ...
    steps: [
      {
        n: "01",
        title: "Tell us your must-haves",
        body: "Area, budget, move-in date and dealbreakers.",
      },
      {
        n: "02",
        title: "Get matched rentals",
        body: "Options that fit, sent as they come available.",
      },
